...
def readinFile():
    os.system("rm config_11.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_11.txt")
    try:
        with open("config_11.txt", "r") as file:
