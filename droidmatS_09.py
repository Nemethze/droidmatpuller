...
def readinFile():
    os.system("rm config_09.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_09.txt")
    try:
        with open("config_09.txt", "r") as file:
