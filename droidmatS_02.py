...
def readinFile():
    os.system("rm config_02.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_02.txt")
    try:
        with open("config_02.txt", "r") as file:
