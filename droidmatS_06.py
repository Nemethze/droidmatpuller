...
def readinFile():
    os.system("rm config_06.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_06.txt")
    try:
        with open("config_06.txt", "r") as file:
