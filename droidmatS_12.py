...
def readinFile():
    os.system("rm config_12.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_12.txt")
    try:
        with open("config_12.txt", "r") as file:
