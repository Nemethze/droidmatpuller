...
def readinFile():
    os.system("rm config_04.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_04.txt")
    with open("config_04.txt", "r") as file:
