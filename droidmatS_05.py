...
def readinFile():
    os.system("rm config_05.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_05.txt")
    try:
        with open("config_05.txt", "r") as file:
