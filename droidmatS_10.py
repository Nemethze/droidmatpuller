...
def readinFile():
    os.system("rm config_10.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_10.txt")
    try:
        with open("config_10.txt", "r") as file:
