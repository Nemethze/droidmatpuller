...
def readinFile():
    os.system("rm config_08.txt")
    os.system("wget https://raw.githubusercontent.com/Nemethze/droidmatpuller/refs/heads/main/config_08.txt")
    try:
        with open("config_08.txt", "r") as file:
